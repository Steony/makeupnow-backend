...
public class UserService {
    ...
    public boolean registerUser(Role role, String firstname, String lastname, String email, String password, String address, String phoneNumber) {
        ...
        // Log après sauvegarde, id disponible
   ...
   public boolean loginUser(String email, String password) {
    ...
    if (userOpt.isPresent()) {
        ...
        if (matches) {
            userActionLogService.logActionByUserId(userOpt.get().getId(), "Connexion", "Connexion réussie");
        } else {
            userActionLogService.logActionByUserId(userOpt.get().getId(), "Connexion", "Échec de connexion : mauvais mot de passe");
        }
        return matches;
    }
...
public boolean updateUser(Long id, String firstname, String lastname, String email, String password, String address, String phoneNumber) {
    ...
    // Pour le password, on ne log pas la valeur exacte, juste un changement
